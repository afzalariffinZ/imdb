...
if ($id) {
    $title_obj = getShort($id); // Assumes getTitle returns a single title object or null
} else {
    $count = getShortsCount($title_str);
    $titles_list = getShorts($offset, $limit, $title_str);
}
?>
