...
<head>
    ...
    <title><?= isset($_GET["id"]) ? "Title Details" : "Browse Series" ?> - IMDb2</title>
...
if ($id) {
    $title_obj = getSeries($id); // Assumes getTitle returns a single title object or null
} else {
    $count = getSeriesCount($title_str);
    $titles_list = getAllSeries($offset, $limit, $title_str);
}
?>
